...
pub struct DocumentKey {
    pub signed_document_key_id: Data,
    pub encrypted_key: EncryptedDocumentKey,
}
    ...
    pub async fn encrypt(
        ...
        let encrypted_document = self
            ...
            .secretstore_encrypt(
                address,
                password,
                document_key.encrypted_key.encrypted_key,
        ...
        self.shadow_client
            .store_document_key(
                document_id,
                &document_key.signed_document_key_id,
                document_key.encrypted_key.common_point,
                document_key.encrypted_key.encrypted_point,
            )
            .await?;
